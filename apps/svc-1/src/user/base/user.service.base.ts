...
import { Prisma, User as PrismaUser, Muly as PrismaMuly } from "@prisma/client";
...
export class UserServiceBase {
  ...
  async getMyMuly(parentId: string): Promise<PrismaMuly | null> {
    return this.prisma.user
      .findUnique({
        where: { id: parentId },
      })
